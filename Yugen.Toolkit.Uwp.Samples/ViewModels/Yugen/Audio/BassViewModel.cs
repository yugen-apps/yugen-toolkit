...
namespace Yugen.Audio.Samples.ViewModels
{
	public class BassViewModel : ViewModelBase
	{
		...
		//private IAudioPlaybackService _audioPlayer;
		...
		{
			get => 0; // _audioPlayer.Position.TotalSeconds;
			set
			{
		...
		public float Bpm => 0; // _audioPlayer.Bpm;

		public float Rms => 0; // _audioPlayer.Rms;
		...
		public double Volume
		{
			...
			set
			{
				...
				{
					_audioPlayer.ChangeVolume(value, 1);
				}
			}
		}
		...
		public double Pitch
		{
			...
			set
			{
				...
				{
					_audioPlayer.ChangePitch(value);
				}
			}
		}
		...
		public void OnLoadCommandBehavior()
		{
			...
			//_audioPlayer = new AudioPlaybackService(_audioDeviceService);
		...
		private void Play2CommandBehavior() => _audioPlayer.TogglePlay(false);

		private void StopCommandBehavior() => _audioPlayer.TogglePlay(true);
	}
}